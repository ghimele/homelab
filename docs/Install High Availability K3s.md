...
Run the following command to get the token and use it to join the other servers
...
```bash
curl -sfL https://get.k3s.io | K3S_TOKEN=K10c0db90f59d1c5fcef1bf6c94d9007d438f655d049a3a3b805d202df8a247a027::server:bb9b6917d5566f2f345b3956abba93b6 sh -s - server \
